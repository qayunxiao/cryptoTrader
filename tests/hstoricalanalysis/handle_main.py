...
if __name__ == '__main__':
    ...
    print("恐慌和ahr指标汇总:今日:{},恐慌指数:{},昨日恐慌指数:{},今日ahr999值:{},昨日ahr999值:{},定投线1.2,"
          "抄底线0.45,今日价格:{},拟合价格:{},200日定投成本:{}".format((time.strftime('%Y年%m月%d日')),(fear_value[0]),(fear_value[1]),(ahr_value['ahr999']),(ahr_value['yesterdayahr999']),
           (ahr_value['price']),(ahr_value['niheprice']),(ahr_value['200']) ))
    ...
    try:
        ...
        receicers=["yunxiao88888888@gmail.com","qawanghailin@gmail.com"]
