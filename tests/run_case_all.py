...
class run_priceX():
    ...
    def __init__(self):
        ...
        self.costPricecountOlStack1 = [{'DOT':[3925.00 ,7.06 ]},{'CAKE':[1147.00 ,5.13 ]},{'ATOM':[480.00 ,10.00 ]},{'ATOM':[192.59 ,9.39 ]},{'TIA':[70.00 ,15.00 ]},{'MANTA':[500.00 ,1.60 ]},{'MANTA':[20.00,2.60 ]},{'MANTA':[420.00 ,2.93 ]},{'MANTA':[1072.00 ,2.86 ]} ,{'PYTH':[6180.00 ,0.40 ]},{'PYTH':[0.50 ,80.00 ]},{'SOL':[1.00 ,450.00 ]},{'SOL':[6.00 ,90.00 ]},{'SOL':[7.00 ,100.00 ]},{'ETH':[1.04 ,2300.00 ]},{'ETH':[1.04 ,2300.00 ]},{'ETH':[1.09 ,2300.00 ]},{'BTC':[0.08 ,41000.00 ]}]
