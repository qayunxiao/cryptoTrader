...
class run_priceX():
    ...
    def __init__(self):
        ...
        self.costPricecountxiaohao2 = [{'BNB':[306,7]},{'BNB':[280,10]},{'BLUR':[0.65,6000]},{'STORJ':[0.71,4633]},{'STX':[2.95,677]},{'STX':[2.85,500]},{'GALA':[0.0275,72727]},{'PYTH':[0.53,2270]},{'PYTH':[0.58,2472]},{'UNI':[10.9,222]},{'SOL':[108,10]},{'SOL':[88,9]},{'FIL':[6.4,200]},{'TIA':[16.8,114]},{'CKB':[0.0155,109268]},{'AGIX':[0.66,1515]},{'ALT':[0.479,2044]},{'MANTA':[2.9,251]},{'RIF':[0.223,4484]}]
