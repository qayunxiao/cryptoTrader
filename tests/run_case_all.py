...
class run_priceX():
    ...
    def __init__(self):
        ...
        self.costPricecountxiaohao2 = [{'BNB': [306, 7]}, {'BNB': [280, 10]}, {'BNB': [366, 8]}, {'BNB': [377, 6]},{'ZEC': [30, 110]}, {'ZEC': [27, 100]}, {'FIL': [6.4, 200]}, {'FIL': [8.7, 300]},{'STORJ': [0.71, 4633]}, {'OP': [3.86, 518]}, {'OP': [4.2, 178]},{'OP': [4.45, 168]}, {'TIA': [16.8, 114]}, {'TIA': [15.4, 100]},{'PYTH': [0.53, 2270]}, {'PYTH': [0.58, 2472]}, {'UNI': [10.9, 222]},{'STX': [2.95, 677]}, {'STX': [2.85, 500]}, {'GALA': [0.0275, 72727]},{'DOT': [9, 200]}, {'SOL': [108, 10]}, {'SOL': [88, 9]},{'CKB': [0.0155, 109268]}, {'AGIX': [0.66, 1515]}, {'MANTA': [2.9, 399]},{'THETA': [2.18, 458]}, {'RIF': [0.223, 4484]}, {'ALT': [0.479, 2044]},{'SUI': [1.5, 599]}, {'STRK': [1.99, 251]}, {'FOR': [0.028, 16175]}]
