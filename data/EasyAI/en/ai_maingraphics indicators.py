# -*- coding: utf-8 -*-
# @Time    : 2022/9/10 13:34
# @Author  : alvin
# @File    : ai_maingraphics indicators.py
# @Software: PyCharm
//@version=5
//create by alvin@ai
indicator(title="ai_maingraphics indicators", shorttitle="ai_maingraphics indicators",overlay=true,max_boxes_count = 300,max_labels_count=500,max_lines_count=500,max_bars_back=500)
//买卖点

// HighLow_Indicators=input(false,title ="highlow")
Channel_Indicators=input(false,title ="Channel Show")
Chip_Indicators=input(false,title ="Chip distribution Chart")
BuySell_Indicators=input(false,title ="Buying and Selling tips")
TD9 = input(false,title ="magic Nine turn")
RGTrend_Indicators=input(false,title ="Red and Green trend line")
UpDownTrend_Indicators=input(false,title ="Support pressure line")
//Double_Trend_Indicators=input(false,title ="双均线战法")
// RSI_Indicators=input(false,title ="多空提示预警")
//方向线及多空背景
DirectionLine_Indicators=input(false,title ="Direction line and multi - space background")
...
alertcondition(buySignal, title="Buying tips", message="Buying tips")
alertcondition(sellSignal, title="Selling tips", message="Selling tips")
//..................................................................优胜_买卖提示结束
...
bgcolor(showZones ? ruleState == 1 ? color.new(color.blue,90) : ruleState == -1 ? color.new(color.red,90) : color.new(color.gray,90) : na, title=" Bullish/Bearish Zones")
...
alertcondition(sell, title='Support line buy', message='Support line buy')
alertcondition(buy, title='Support line sell', message='Support line sell')
...
if show_miss
if os[1] == 1
label.new(min_x1,min,'low',color=miss_pl_css,style=label.style_label_up,size=size.small,
// label.new(min_x1,min,'lowtwo',color=miss_pl_css,style=label.style_label_up,size=size.small,
...
label.new(max_x1,max,'low',color=miss_ph_css,style=label.style_label_down,size=size.small,
// label.new(max_x1,max,'low1',color=miss_ph_css,style=label.style_label_down,size=size.small,
tooltip=str.tostring(max,'#.####'))
// label.new(follow_min_x1,follow_min,'high2',color=miss_pl_css,style=label.style_label_up,size=size.small,
label.new(follow_min_x1,follow_min,'high',color=miss_pl_css,style=label.style_label_up,size=size.small,
tooltip=str.tostring(min,'#.####'))
...
if show_reg
label.new(n-length_HighLow_Indicators,ph,'high',textcolor=label_css,color=reg_ph_css,style=label.style_label_down,size=size.small,
...
if show_miss
if os[1] == 0
   // label.new(max_x1,max,'highONE',color=miss_ph_css,style=label.style_label_down,size=size.small,
                label.new(max_x1,max,'high',color=miss_ph_css,style=label.style_label_down,size=size.small,
                          tooltip=str.tostring(max,'#.####'))
...
// label.new(follow_max_x1,follow_max,'low3',color=miss_ph_css,style=label.style_label_down,size=size.small,
label.new(follow_max_x1,follow_max,'low',color=miss_ph_css,style=label.style_label_down,size=size.small,
tooltip=str.tostring(max,'#.####'))
// label.new(min_x1,min,'high3',color=miss_pl_css,style=label.style_label_up,size=size.small,
label.new(min_x1,min,'high',color=miss_pl_css,style=label.style_label_up,size=size.small,
tooltip=str.tostring(min,'#.####'))
...
if show_reg
label.new(n-length_HighLow_Indicators,pl,'low',textcolor=label_css,color=reg_pl_css,style=label.style_label_up,size=size.small,
...
if show_miss
   // lbl := label.new(x,y,'👻',color=miss_pl_css,style=label.style_label_up,size=size.small,  lowONE
lbl := label.new(x,y,'low',color=miss_pl_css,style=label.style_label_up,size=size.small,
...
if show_miss
   // lbl := label.new(x,y,'👻',color=miss_ph_css,style=label.style_label_down,size=size.small,
             // lbl := label.new(x,y,'hightwo',color=miss_ph_css,style=label.style_label_down,size=size.small,
                                 lbl := label.new(x,y,'high',color=miss_ph_css,style=label.style_label_down,size=size.small,
                                                  tooltip=str.tostring(y,'#.####'))
