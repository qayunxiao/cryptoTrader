...
def get_date():
	print("get_date  date_01 ",ExcelVariable.date_01)
	return ExcelVariable.date_01

def get_ad_type():
	return ExcelVariable.ad_type

def get_ad_name():
	return ExcelVariable.ad_name

def get_ad_package():
	return ExcelVariable.ad_package

def get_ad_channel():
	return ExcelVariable.ad_channel

def get_ad_activenum():
	return ExcelVariable.ad_activenum

def get_ad_active_remark():
	return ExcelVariable.active_remark
